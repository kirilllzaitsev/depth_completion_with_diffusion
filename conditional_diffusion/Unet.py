...
from minimagen.helpers import cast_tuple, default, exists, prob_mask_like
from minimagen.layers import (
    Attention,
    CrossEmbedLayer,
    Downsample,
    Identity,
...
from rsl_depth_completion.conditional_diffusion.train_utils import concatenate_tensors
    ...
    def forward(
        ...
        *,
        ...
        if exists(lowres_cond_img):
            x = concatenate_tensors(x, lowres_cond_img)
        ...
        def add_skip_connection(x):
            ...
            return concatenate_tensors(x, last_hidden * self.skip_connect_scale)
        ...
        if self.init_conv_to_final_conv_residual:
            x = concatenate_tensors(x, init_conv_residual)
