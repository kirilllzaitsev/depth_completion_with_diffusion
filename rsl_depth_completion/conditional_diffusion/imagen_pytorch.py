...
class Imagen(nn.Module):
    ...
    def p_losses(
        ...
        **kwargs
        ...
        # return losses.mean()
        return {pred_objective: losses.mean(), "diff_to_orig_img": (noise - pred).abs().mean()}
